**********************************************************************  
* Robot and energy consumption project
* Singapore Employment Statistics clean do-file
**********************************************************************
clear all

	global main "/Users/jeongjaehui/Dropbox/Energy"
	global data "${main}/Data cleaned"
	global interim "${main}/Data interim"
	global final "${main}/Data final"
	global coe "${main}/Data raw/COE"	
...
/*******************************************************************************
	import excel
*******************************************************************************/
import excel "$singapore/mrsd_65_annl_emp_lvl_by_ind_singapore.xlsx", sheet("SSIC1996") cellrange(A3) firstrow clear
drop SSIC1996
...
drop if Industry == ""
drop N O P
save "$singapore/interim/sgp_empl1.dta", replace


import excel "$singapore/mrsd_65_annl_emp_lvl_by_ind_singapore.xlsx", sheet("SSIC2005") cellrange(A3) firstrow clear
drop SSIC2005
...
drop if Industry == ""
drop J - O
save "$singapore/interim/sgp_empl2.dta", replace

import excel "$singapore/mrsd_65_annl_emp_lvl_by_ind_singapore.xlsx", sheet("SSIC2020") cellrange(A3) firstrow clear
drop SSIC2020
...
drop if Industry == ""
drop U - W
save "$singapore/interim/sgp_empl3.dta", replace

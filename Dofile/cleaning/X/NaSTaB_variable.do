...
use "/Users/ihuila/Desktop/data/master thesis/raw/afterclean/afterNaSTaB/NaSTaB_final.dta", clear 
...
xi: xtivreg28 poli i.year $demo (DRobot_exp_all1995=SG_DRobot_exp_all1995), fe cluster(clusterid) robust first // marginally significant 

xi: xtivreg28 poli i.year $demo (p_immi0=p_iv_immi0), fe cluster(clusterid) robust first // left 

xi: xtivreg28 poli i.year $demo (p_immi0=p_iv_immi0) if gender==1, fe cluster(clusterid) robust first // left 

xi: xtivreg28 poli i.year $demo (p_immi0=p_iv_immi0) if gender==2, fe cluster(clusterid) robust first // left 



xi: xtivreg28 poli i.year  (p_immi0=p_iv_immi0), fe cluster(clusterid) robust first // left 

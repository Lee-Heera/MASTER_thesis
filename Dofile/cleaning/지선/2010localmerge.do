...
local in "/Users/ihuila/Desktop/data/master thesis/raw/LocalE/2010"
local out "/Users/ihuila/Desktop/data/master thesis/afterlocal/2010"
...
foreach region of local files {
    ...
    local fname "개표현황[제5회][지방선거][시·도지사선거][`region'].xlsx"
...
cd "/Users/ihuila/Desktop/data/master thesis/afterlocal/2010"
...
**********************STEP 3 append 해서 2010년 전국 데이터로 만들것 
use "강원도.dta", replace 
...
save 2010localmerge.dta, replace 
*************************** cleaning ***************************************
use 2010localmerge.dta, clear 
...
destring 선거인수 투표수 한나라당 민주당 유효투표수 무효투표 기권, replace ignore(",")
...
********************************************************************************
local varlist 선거인수 투표수 한나라당 민주당 유효투표수 무효투표 기권
...
********************************************************************************
local varlist 선거인수 투표수 한나라당 민주당 유효투표수 무효투표 기권
local cities  "부천시 수원시 성남시 안양시 안산시 고양시 용인시 전주시 포항시 천안시"

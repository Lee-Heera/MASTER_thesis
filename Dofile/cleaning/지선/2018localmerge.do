...
local in "/Users/ihuila/Desktop/data/master thesis/raw/LocalE/2018"
local out "/Users/ihuila/Desktop/data/master thesis/afterlocal/2018"
...
foreach region of local files {
    ...
    local fname "개표현황[제7회][지방선거][시·도지사선거][`region'].xlsx"
...
cd "/Users/ihuila/Desktop/data/master thesis/afterlocal/2018"
...
**********************STEP 3 append 해서 2018년 전국 데이터로 만들것 
use "강원도.dta", replace 
...
save 2018localmerge.dta, replace 
*************************** cleaning ***************************************
use 2018localmerge.dta, clear 
...
destring 선거인수 투표수 더불어민주당 자유한국당 유효투표수 무효투표 기권, replace ignore(",")
...
********************************************************************************
local varlist 선거인수 투표수 더불어민주당 자유한국당 유효투표수 무효투표 기권

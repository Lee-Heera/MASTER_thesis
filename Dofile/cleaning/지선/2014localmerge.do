...
local in "/Users/ihuila/Desktop/data/master thesis/raw/LocalE/2014"
local out "/Users/ihuila/Desktop/data/master thesis/afterlocal/2014"
...
foreach region of local files {
    ...
    local fname "개표현황[제6회][지방선거][시·도지사선거][`region'].xlsx"
...
cd "/Users/ihuila/Desktop/data/master thesis/afterlocal/2014"
...
**********************STEP 3 append 해서 2014년 전국 데이터로 만들것 
use "강원도.dta", replace 
...
save 2014localmerge.dta, replace 
*************************** cleaning ***************************************
use 2014localmerge.dta, clear 
...
destring 선거인수 투표수 새누리당 새정치민주연합 유효투표수 무효투표 기권, replace ignore(",")
...
********************************************************************************
local varlist 선거인수 투표수 새누리당 새정치민주연합 유효투표수 무효투표 기권 무효투표 기권
local target   "청주시"
...
********************************************************************************
local varlist 선거인수 투표수 새누리당 새정치민주연합 유효투표수 무효투표 기권

...
**********************************************************************
// 파일 이름과 시도명 매칭 리스트
local in "$main/Data raw/대선_개표/2022"
local out "$interim/대선_개표/2022"
...
foreach region of local files {
    ...
    local fname "개표현황[제20대][대통령선거][`region'].xlsx"
...
// 2단계: append로 하나로 합치기
use "$interim/대선_개표/2022/강원도.dta", clear

cd "$interim/대선_개표/2022"
local files  `" "강원도" "경기도" "경상남도" "경상북도" "광주광역시" "대구광역시" "대전광역시" "부산광역시" "서울특별시" "울산광역시" "인천광역시" "전라남도" "전라북도" "제주특별자치도" "충청남도" "충청북도" "세종특별자치시" "'
...
save "$interim/대선_개표/2022/preappend.dta", replace
**********************************************************************************
** cleaning 
use "$interim/대선_개표/2022/preappend.dta", clear 
...
save  "$data/2022president_clean.dta", replace 

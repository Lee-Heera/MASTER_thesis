...
// 2. 통제변수 머지하기 
merge m:n regioncode year using "/Users/ihuila/Desktop/data/master thesis/raw/afterclean/sigungucontrol.dta"
...
// 3. immigranst IV 
merge m:n year sido_nm sigungu_nm using "/Users/ihuila/Desktop/data/master thesis/raw/afterclean/KOREA_immigration_clean.dta" 

br if _merge==1 // 없음 

tab year if _merge==2 // 2007년도, 2008년도 데이터 

keep if _merge==3 
drop _merge 

// 4. manufacturing 
merge m:n year sido_nm sigungu_nm using "/Users/ihuila/Desktop/data/master thesis/raw/afterclean/aftermanu/2010_2023.dta" 

br if _merge==1 
tab year if _merge==1 // 1.2009년도 데이터, 2. 2010년도 세종시 

tab year if _merge==2  // 1. 2023년도 데이터(manufacturing) 2. 제주시, 서귀포시 3. 마산시, 진해시 
br if _merge==2 & year!=2023

drop if _merge==2 
drop if _merge==1 & year==2009 // 일단은 2010년도 세종시 안삭제하고 남겨놓음 

tab year 

save "spendingimmi.dta", replace 
*********************************************************************
use "spendingimmi.dta", clear 
...
save "/Users/ihuila/Desktop/data/master thesis/raw/afterclean/afterspending/spendingimmi.dta",replace
